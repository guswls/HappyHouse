         ...
         <div class="card col-sm-12" style="min-height: 850px; align: center">
            <div class="card-body">
               ...
               <script>
                  ...
                  $(document)
                        .on(
                              ...
                              "#dong",
                              function() {
                                 const dong = $("#dong :selected")
                                       .html();
                                 const code = $("#dong :selected")
                                       .val();
                                 console.log(dong);
                                 console.log(code);
                                 $
               ...
               <div class="container row" style="align: center">
                  ...
                  </select> 구/군 : <select class="form-control col-md-3" id="gugun">
                     <option value="0">선택</option>
                  </select> 읍/면/동 : <select class="form-control col-md-3" id="dong">
                     <option value="0">선택</option>
                  </select>
               </div>
               <br>
               ...
               <script async defer
                  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAF4qweFIAhUwezQWZ1x8h0IDHEks2o9E&callback=initMap"></script>
               <script>
                  var multi = {
                     lat : 37.5665734,
                     lng : 126.978179
